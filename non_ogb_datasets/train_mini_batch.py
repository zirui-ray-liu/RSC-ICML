...
from fastgnn import get_memory_usage, compute_tensor_bytes, exp_recorder, config, ApproxModule, Scheme, get_A_row_norms
import models
...
parser.add_argument('--switch_time', type=float, default=0.5)
